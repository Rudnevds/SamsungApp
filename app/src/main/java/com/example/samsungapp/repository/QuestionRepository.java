...
public class QuestionRepository {
    ...
    public void getResults() {
        ...
        firebaseFirestore.collection("Quiz").document(quizId).collection("results")
    ...
    //Работа базы данных с вопросами
    public void getQuestions(){
        firebaseFirestore.collection("Quiz").document(quizId).collection("questions").get()
